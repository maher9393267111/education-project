          ...
          <div className="rc__post-wrapper">
            <div className="rc__post d-flex align-items-center">
              ...
              <div className="rc__content">
                ...
                <h6 className="rc__title">
                  <Link href="/blog-details">
                    <a>The Importance Intrinsic Motivation.</a>
                  </Link>
                </h6>
              </div>
            </div>
            <div className="rc__post d-flex align-items-center">
              ...
              <div className="rc__content">
                ...
                <h6 className="rc__title">
                  <Link href="/blog-details">
                    <a>A Better Alternative To Grading Student.</a>
                  </Link>
                </h6>
              </div>
            </div>
            <div className="rc__post d-flex align-items-center">
              ...
              <div className="rc__content">
                ...
                <h6 className="rc__title">
                  <Link href="/blog-details">
                    <a>Strategic Social Media & Evolution of Visual</a>
                  </Link>
                </h6>
              </div>
            </div>
