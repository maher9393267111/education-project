                ...
                <div className="col-xxl-8 col-xl-8 col-lg-8">
                  <div className="course__wrapper">
                    ...
                    <div className="course__meta-2 d-sm-flex mb-30">
                      <div className="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                        <div className="course__teacher-thumb-3 mr-15">
                          <img
                            src="https://picsum.photos/800/780"
                            alt="img not found"
                          />
                        </div>
                    ...
                    <div className="course__img w-img mb-30">
                      <img
                        src="https://picsum.photos/1540/900"
                        alt="img not found"
                      />
                    </div>
                    <Tabs>
                          ...
                          <TabPanel>
                            <div className="course__description">
                              ...
                              <p>
                                ...
                                grub cheers ruddy cor blimey guvnor in my flat,
                                up the duff Eaton car boot up the kyver pardon
                                you A bit of how's your father David skive off
                                sloshed, don't get shirty with me chip shop
                                vagabond crikey bugger Queen's English chap.
                                Matie boy nancy boy bite your arm off up the
                                kyver old no biggie fantastic boot, David have
                                it show off show off pick your nose and blow off
                                lost the plot porkies bits and bobs only a quid
                                bugger all mate, absolutely bladdered bamboozled
                                it's your round don't get shirty with me down
                                the pub well. Give us a bell bits and bobs
                                Charles he lost his bottle super my lady cras
                                starkers bite your arm off Queen's English,
                                pardon me horse play Elizabeth a blinding shot
                                chinwag knees up do one David, blag cup of tea
                                Eaton so I said bleeding haggle James Bond cup
                                of char. Gosh William ummm I'm telling crikey
                                burke I don't want no agro A bit of how's your
                                father bugger all mate off his nut that, what a
                                plonker cuppa owt to do with me nancy boy show
                                off show off pick your nose and blow off
                                spiffing good time lavatory me old mucker,
                                chimney pot what a load of rubbish boot squiffy
                              ...
                              <div className="course__description-list mb-45">
                                ...
                                <ul>
                                  <li>
                                    {" "}
                                    <i className="fas fa-check"></i> Business's
                                    managers, leaders
                                  </li>
                                  <li>
                                    {" "}
                                  ...
                                  <li>
                                    {" "}
                                    <i className="fas fa-check"></i> Anyone who
                                    is finding a chance to get the promotion
                                  </li>
                                </ul>
                              </div>
